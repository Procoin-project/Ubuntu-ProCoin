...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Procoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"procointools.com", "dnsseed.procointools.com"},
    {"procoinpool.org", "dnsseed.procoinpool.org"},
    {"xurious.com", "dnsseed.pro.xurious.com"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"procointools.com", "testnet-seed.procointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Procoin is probably already running."), addrBind.ToString().c_str());
        else
